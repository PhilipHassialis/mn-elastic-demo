package com.hassialis.philip.es;
...
import com.hassialis.philip.Constants;
...
public class DataEndpoint {
    ...
    client.getAsync(new GetRequest(Constants.INDEX, documentId), RequestOptions.DEFAULT,
        new ActionListener<GetResponse>() {
          ...
          public void onFailure(Exception e) {
            LOG.error("Error while getting document", e);
  ...
  public CompletableFuture<String> byFirstName(@PathVariable("search") String search) {
    ...
    client.asyncSearch().submitAsync(new SubmitAsyncSearchRequest(source, Constants.INDEX),
